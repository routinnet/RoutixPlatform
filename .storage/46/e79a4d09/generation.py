...
"""
from sqlalchemy import Column, String, Text, Integer, DECIMAL, Boolean, DateTime
...
class GenerationRequest(BaseModel):
    ...
    algorithm_id = Column(UUID(as_uuid=True), ForeignKey("generation_algorithms.id"), nullable=False)
